    ...
    <div className="container">        
      ...
      <div className="navbar-collapse">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <a className="nav-link btn btn-white btn-round" href="/login">SIGN IN</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div className="card-plain">
          <form className="form" method action="#">
            ...
            <div className="footer text-center">
              <a href="/" >
              <button type="button" onClick={submit} className="btn btn-primary btn-round btn-block  waves-effect waves-light">SIGN UP</button></a>
